...
export default class Renderer {
  ...
  constructor() {
    ...
    const param = {
      ...
      left: -window.innerWidth / 25 + 35,
      right: window.innerWidth / 25 + 35,
      top: window.innerHeight / 25 + 25,
      bottom: -window.innerHeight / 25 + 25,
      near: 0.1,
      far: 10,
    };
    ...
    window.addEventListener(
      'resize',
      () => {
        this.camera.left = -window.innerWidth / 25 + 35;
        this.camera.right = window.innerWidth / 25 + 35;
        this.camera.top = window.innerHeight / 25 + 25;
        this.camera.bottom = -window.innerHeight / 25 + 25;
